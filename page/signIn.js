...
const UselessTextInput = ({ route, navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            {(password.length < 8) && (password.length >= 1) ? <Text style={{ marginLeft: 15, color: "red" }}>รหัสผ่านต้องมีอย่างน้อย 8 ตัว</Text> : ""}
            ...
            {(password === newPassword) || ((newPassword.length < 2) && (password.length <= 8)) ? "" : <Text style={{ marginLeft: 15, color: "red" }}>รหัสผ่านไม่ตรงกัน</Text>}
