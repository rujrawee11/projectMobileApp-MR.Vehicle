            ...
            <SafeAreaView style={{flex: 1, backgroundColor: '#000000aa'}}>
                <SafeAreaView style={styles.outBorder}>
                    ...
                    <View style={[styles.inBorder, {flex:2}]}>   
                        <View style={[styles.inBorder, {flex:1, width:'100%'}]}>
                            <Text style={[styles.headText, {alignSelf: 'flex-start'}]}>ประเภทยานพาหนะ<AntDesign name="close" size={24} color="black" style={{}}/></Text>
                        </View>
