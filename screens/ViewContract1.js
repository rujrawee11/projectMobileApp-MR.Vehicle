...
const MakeContract = ({ route, navigation }) => {
    ...
    // useEffect((id) => {
    //     getDocs(query(collection(db, "vehicleReservation"), where('renterEmail', '==', userRenterEmail)))
    //         .then(docSnap => {
    //             let users = [];
    //             docSnap.forEach((doc) => {
    //                 users.push({ ...doc.data(), id: doc.id })
    ...
    //         console.log(vId)
    //         //  console.log(users)
    //         onChangemodel(users[0].model);
    //         onChangebrand(users[0].brand);
    //         onChangeos(users[0].os);
    //         onChangeseats(users[0].seats);
    //         onChangesize(users[0].size);
    //         onChangevehicleType(users[0].type)
    //         onChangenumber(users[0].number)
    //         onChangerentalEmail(users[0].rentalEmail)
    //         console.log(users[0].id)
    //         console.log(users[0].model)
    //         console.log(users[0].brand)
    //     }).catch((error) => {
    //         // The write failed...
    //         alert(error);
    //     });
